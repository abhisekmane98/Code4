...
// error line 71 user got only one chance to enter npassward
#include<stdio.h>
#include<math.h>
int main()
{
		...
		{		
		    ...
		    break;                // not necessary of writing of if(a==3) think......
		                          // if user enter a=1,2 or any wrong entry then it agin starts program
		                          // but if at starting user enters wrong passward then he or she got only one chance
